...
*   @return Un booleen.
*/
static inline bool TList_IsEmpty(const PTList this             /**< Pointeur vers le type liste.                */); /**< Retourne true si la liste est vide.                                                 */
...
*/
static inline int TList_Length(const PTList this               /**< Pointeur vers le type liste.                */); /**< Retourne la taille de la liste.                                                     */
...
*/
static inline int TList_GetSizeofElem(const PTList this        /**< Pointeur vers le type liste.                */); /**< Retourne la taille unitaire d'un élément.                                           */

/** @fn TList_GoTo
*   @brief Positionne le pointeur courant à la position spécifiée et retourne le nœud courant.
*   @param this Pointeur vers le type liste.
*   @param Pos La position spécifiée.
*   @return Pointeur vers le nœud courant.
*/
static inline PTNode TList_GoTo(const PTList this              /**< Pointeur vers le type liste.                */,
                                int Pos                        /**< La position spécifiée.                      */); /**< Positionne le pointeur courant à la position spécifiée et retourne le nœud courant. */
...
*/
static inline int TList_GetIndex(const PTList this             /**< Pointeur vers le type liste.                */); /**< Retourne la position courante.                                                      */
...
*   @return Pointeur vers le nœud courant.
*/
static inline PTNode TList_InsertFirst(const PTList this       /**< Pointeur vers le type liste.                */,
...
*   @return Un booleen.
*/
static inline bool TList_RemoveFirst(const PTList this         /**< Pointeur vers le type liste.                */); /**< Retire l'élément en début de liste.                                                 */
...
*   @return Pointeur vers le nœud courant.
*/
static inline PTNode TList_Add(const PTList this               /**< Pointeur vers le type liste.                */,
...
*   @return Un booleen.
*/
static inline bool TList_RemoveLast(const PTList this          /**< Pointeur vers le type liste.                */); /**< Retire l'élément en fin de liste.                                                   */
...
*   @return Pointeur vers le nœud courant.
*/
static inline PTNode TList_Insert(const PTList this            /**< Pointeur vers le type liste.                */,
...
*   @return Un booleen.
*/
static inline bool TList_RemoveCurrent(const PTList this       /**< Pointeur vers le type liste.                */); /**< Retire l'élément à la position courante de la liste.                                */

/** @fn TList_Clear
*   @brief Vide la liste.
*   @param this Pointeur vers le type liste.
*/
static inline void TList_Clear(const PTList this               /**< Pointeur vers le type liste.                */); /**< Vide la liste.                                                                      */

/** @fn TList_Delete
*   @brief Supprime la liste en libérant les zones mémoires allouées.
*   @param this Pointeur vers le type liste.
*/
static inline void TList_Delete(const PTList this              /**< Pointeur vers le type liste.                */); /**< Supprime la liste en libérant les zones mémoires allouées.                          */
...
*/
static inline void TList_Display(const PTList this             /**< Pointeur vers le type liste.                */,
