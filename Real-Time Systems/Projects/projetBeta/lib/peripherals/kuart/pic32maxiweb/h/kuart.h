/**
* @file     kuart.h
* @brief    header for uart module library using FreeRTOS kernel for pic32 mcu architecture
...
#define UART_BPS            9600            // uart module default baud rate
#define UART_BUFFER_SIZE    200             // circular buffer size in byte
#define UART_HISTORY_DEPTH  10              // circular history buffer size
#define UART_MAX_STR_SIZE   IO_MAX_STR_SIZE // max string size. TODO optimisation tests...
...
#define uartPutEscCommand(command) {                \
