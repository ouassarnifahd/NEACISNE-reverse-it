...
#define MY_DEFAULT_IP_ADDR_BYTE2        (24ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (123ul)
...
#define MY_DEFAULT_GATE_BYTE2           (24ul)
#define MY_DEFAULT_GATE_BYTE3           (0ul)
#define MY_DEFAULT_GATE_BYTE4           (1ul)

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(193ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(49ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(200ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(16ul)

#define MY_DEFAULT_SECONDARY_DNS_BYTE1	(193ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE2	(49ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE3	(200ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE4	(14ul)
