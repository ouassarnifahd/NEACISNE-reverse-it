...
#define   __PORTAGE_LCD_USER_HEADER__
	...
	/*** on a: TCY = 83,2ns 								***/
	#define	DelayUser_2ms()		Delay1KTCYx(24) 		// 24.1000.TCY 	~ 2 ms  (mesuré = 2ms)
	#define	DelayUser_5ms()		Delay1KTCYx(61)			// 61.1000.TCY 	~ 5 ms  (mesuré = 5ms)
	#define	DelayUser_15ms()	Delay1KTCYx(181)		// 181.1000.TCY ~ 15 ms (mesuré = 15ms)
	#define	DelayUser_400us()	Delay100TCYx(48)		// 48.100.TCY 	~ 400 us
	#define	DelayUser_4us()		Delay10TCYx(5)			// 5.10.TCY 	~ 4 us
