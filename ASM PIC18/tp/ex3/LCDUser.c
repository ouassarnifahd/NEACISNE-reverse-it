...
/*** D�claration variables globales et fonctions (locales � LCDUser.c)***/
...
/*xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx*/
		...
		/*** @param	character : donn�e 8bits >> envoie des 4LSB	***/
		/**********************************************************/
		void LCD_Write_Data_User(char character){

		    /*** envoie des 4bits LSB de character vers le LCD ***/
		    /****************************************************/
		    		D4_PIN_LCD_USER = (0x01 & character);	 //envoie du bit de poids faible de character � la broche n�4 du MCU
...
/*xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx*/
		...
		/**********************************************/
		/*** FONCTION : Envoie caract�re au LCD		***/
		/*** @param	character : caract�re � envoyer	***/
		/**********************************************/
		void LCD_Char_User(char character){

		char  characterL, characterH;

		    /*** Sauvegarde des 4bits LSB et 4 bits MSB du caract�re ***/
		...
		/******************************************************************/
		/*** FONCTION : Envoie cha�ne de caract�res au LCD				***/
		/*** @param	StringData : pointeur sur la cha�ne de caract�res	***/
		/******************************************************************/
		...
		/******************************************************/
		/*** FONCTION : Envoie d'une commande au LCD			***/
		/*** @param	commande : commande sur 8bits � envoyer	***/
		/******************************************************/
		...
		/******************************************************************/
		/*** FONCTION : Envoie caract�re au LCD + positionnement curseur	***/
		/*** @param	row : n� de la ligne (position curseur)				***/
		/*** @param	col : n� de la colonne (position curseur)			***/
		/*** @param	character : donn�e � envoyer						***/
		/******************************************************************/
		void LCD_Char_XY_User(unsigned char row, unsigned char col, char character){
		    ...
		    /*** envoie d'un caract�re � la position courante du curseur ***/
		...
		/******************************************************************************/
		/*** FONCTION : Envoie cha�ne de caract�res au LCD + positionnement curseur	***/
		/*** @param	row : n� de la ligne (position curseur)							***/
		/*** @param	col : n� de la colonne (position curseur)						***/
		/*** @param	StringData : pointeur sur la cha�ne de caract�res				***/
		/******************************************************************************/
