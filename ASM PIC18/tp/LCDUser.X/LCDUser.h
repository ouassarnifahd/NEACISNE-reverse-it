...
#define   __LCD_USER_HEADER__
    ...
    /**** Sélection registre Data ou Instruction (contrôleur LCD) ***/
      #define   REG_IR_USER    0          // écriture dans le registre d'instruction
      #define   REG_DR_USER    1          // écriture dans le registre de donnée
    ...
    /*** Déclaration fonctions externes pour ex3.c ***/
      ...
      extern void LCD_Cursor_XY_User(unsigned char row, unsigned char col);
      ...
      extern void LCD_Write_Data_User(char character);
      extern void LCD_Write_Register_User(char DR_or_IR);
#endif
