...
%Schéma simulink
Temps_Fin = 10;   % Durée de la simulation
...
%valeurs des parametres de synthèse pour l asservissement
w_reg=1.5*w0;        % pulsation naturelle dominante en regulation
wp=w_reg/2;
w=logspace(-3,5,500);
mu = 10;

%Synthèse des 4 regulateurs

%Regulateur 1
[reg1,Rn_1,Rd_1,Pc_1]=calculregulateur1(B,A,w_reg,mu);

%Regulateur 2
[reg2,Rn_2,Rd_2,Pc_2]=calculregulateur2(B,A,w_reg,mu);

%Regulateur 3
[reg3,Rn_3,Rd_3,Rp_3,Pc_3]=calculregulateur3(B,A,w_reg,mu);

%Regulateur 4
[reg4,Rn_4,Rd_4,Rp_4,Pc_4]=calculregulateur3(B,A,w_reg,mu);


%%
%********************************
%I Analyse du systeme à commander
%********************************

figure(1);
title('Réponse impulsionnelle du système à commander');
impulse(G1);

figure(2);
title('Position des pôles et des zéros du système à commander');
pzmap(G1);

%%
%Essai sous Simulink
%Sélection des signaux d excitation
entree_bo=1;
pertu_bo=1;
...
%Calcul des objets systèmes pour le schéma simulink
...
%Calcul des objets systèmes pour le schéma simulink (Code a demasquer pour
